...
{
    public class UpdatePartidoCommand : Notifiable, ICommand
    {
        ...
        public UpdatePartidoCommand()
        {
            
        }

        public UpdatePartidoCommand(Guid id, string nome, string sigla, int numero, string imagem)
        {
            Id = id;
            Nome = nome;
            Sigla = sigla;
