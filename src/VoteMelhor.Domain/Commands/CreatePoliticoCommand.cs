...
{
    public class CreatePoliticoCommand : Notifiable, ICommand
    {        
        ...
        public CreatePoliticoCommand()
        {
            
        }

        public CreatePoliticoCommand(int id, string nome, EstadoEnum estado, string imagem)
        {
            Id = id;
            Nome = nome;
            Estado = estado;
